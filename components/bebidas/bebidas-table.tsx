...
const columns: ColumnDef<Producto>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const setPlatoToUpdate = useBebidasStore(
        (state) => state.setBebidaToUpdate
      );
      const setOpenUpdateDialog = useBebidasStore(
        (state) => state.setOpenUpdateDialog
      );

      const deleteBebidaFromStore = useBebidasStore(
        (state) => state.deleteBebidaFromStore
      );
      ...
      return (
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem onClick={() => borrarBebida(plato.id)}>
